...
from ..ingest.detect import PARSERS, detect_language, resolve_parser
...
def _persist_document(session: Session, document: Document, source_path: Path, source_format: str) -> Book:
...
async def upload_book(
    ...
    book = _persist_document(session, document, dest_path, source_format)
